...
export type SeeFeedQuery = { __typename?: 'Query', seeFeed?: Array<{ __typename?: 'Photo', id: number, caption?: string | null, likes: number, isMine: boolean, comments: number, user: { __typename?: 'User', username: string } } | null> | null };
